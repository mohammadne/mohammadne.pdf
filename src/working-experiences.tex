...
\cventry{2024--Current}{Senior Software Engineer}{Asan Pardakht}{Tehran, Iran}{}{%
  \begin{itemize}
    \item Develped and maintain a service for handling application layout for over 50 million users. Implemented features to synchronize and enforce updates on specific UI components, tailored to diverse user policies.
    \item Maintained and Enhance the SMS Gateway, critical for payment services and user authentication. also Developed a Kubernetes operator to streamline the management of SMS templates.
    \item Maintained the Discount Service, enabling users to access offers such as ticket purchases. Built and maintained a back-office system for seamless management.
