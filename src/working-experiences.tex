...
\cventry{2023--current}{Cloud Engineer}{Snapp!}{Tehran, Iran}{}{%
  \begin{itemize}
    ...
    \item Manage more than 200K active connections and 30k rps by two layers of load balancing across two data centres using OpenShift Public, Private, and Inter Clusters routers.
