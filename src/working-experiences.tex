...
\cventry{2024--current}{Software Engineer}{AsanPardakht}{Tehran, Iran}{}{%
  \begin{itemize}
    \item Consult the platform team to automate infrastructure tasks via a Kubernetes controller
  \end{itemize}
}
